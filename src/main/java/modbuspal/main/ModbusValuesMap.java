...
/**
 * This class has been created especially to handle the registers of a MODBUS
 * slave.
 * 
 * @author nnovic
 */
public class ModbusValuesMap {
	...
	/**
	 * Checks if the register with the specified index has been marked as added.
	 * 
	...
	/**
	 * Returns the register index corresponding to the order at which it has been
	 * added in the map. For example, if the first index added to the map was
	 * register #135, then getIndexOf(0) returns 135.
	 * 
	...
	/**
	 * Get the order of the register identified by the specified index. For example,
	 * if the first register added to the map was #135, then getOrderOf(135) returns
	 * 0;
	 * 
