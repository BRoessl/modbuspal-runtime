...
/**
 * objects interested in receiving notifications from the modbuspal project must
...
public interface ModbusPalProjectListener {
	/**
	 * this method is triggered by ModbusPalProject when the project is modified
	 * 
