...
/**
 * takes care of some particularies of the management of the modbus slaves in
 * the project
 * 
 * @author nnovic
 */
public abstract class ModbusPalProject2 {
	...
	/**
	 * tries to retrieve an already existing ModbusSlaveAddress instance that might
	 * match the one in argument.
	 * 
	 * @param id
	 * @return tries
	 */
	...
	/**
	 * Returns the MODBUS slave identified by its slave number. If the slave does
	 * not exist, and if createIfNotExist is true, then the slave is created
	 * on-the-fly.
	 * 
	 * @param id               the slave number
	 * @param createIfNotExist if true, and if there is no defined MODBUS slave for
	 *                         the specified slave number, then it is created.
	 * @return the instance of ModbusSlave associated with the slave number or null
	 *         if no slave is associated with this number.
	 */
	 ...
	 * @return the modbus slave was defined for this number before being replace, or
	 *         null if there was no modbus slave previously defined for this slave
	 *         number.
	 */
	...
	/**
	 * Triggers the listeners to notify them of the removal of a MODBUS slave from
	 * the project.
	 * 
	...
	/**
	 * Triggers the listeners to notify them of the addition of a new MODBUS slave
	 * in the project.
	 * 
