...
public class ErrorMessage extends javax.swing.JDialog implements ActionListener {
	 ...
	 * 
	 * @param nbButtons the number of buttons that will be created in the dialog
	 */
	...
	/**
	 * Creates a new form ErrorMessage with only one button. The text of the button
	 * is provided by the "text" argument".
	 * 
	...
	/**
	 * Appends some text to the current text displayed by the dialog.
	 * 
