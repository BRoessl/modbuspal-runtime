...
public class ModbusPalGui {
	...
	/**
	 * This method will display the help message to the console and exit the
	 * software.
	 */
	public static void displayHelpMessage() {
		...
		System.out
				.println("-install (optional): This flag is to tell program to install itself if it is not installed.");
	...
	/**
	 * This method gets the initial port number to load specified by the user in the
	 * command line arguments.
	 * 
	 * @return {int} The initial port number for TCP/IP connections. Returns -1 if
	...
	/**
	 * this method will try to change the Look and Feel of the application, using
	 * the system l&f. It means that the application will get the Windows l&f on
	 * Windows, etc...
	 */
	...
	/**
	 * Creates a ModbusPalFrame. The internal console of ModbusPal is enabled.
	 * 
	...
	/**
	 * Creates a ModbusPalInternalFrame. The internal console of ModbusPal is
	 * enabled.
	 * 
	...
	/**
	 * Creates a ModbusPalPane instance. The internal console of ModbusPal is
	 * disabled.
	 * 
	...
	/**
	 * Returns a ModbusPalPane instance that is associated with the specified key,
	 * as in a HashMap. If there is no ModusPalPane associated with that key, a new
	 * one is created. Otherwise, the existing one is returned
	 * 
