...
/**
 * An object interested in ModbusPal related events should implement this
 * interface.
 * 
 * @author nnovic
 */
public interface ModbusPalListener {
	...
	/**
	 * This method is triggered when a PDU has been successfully processed by
	 * ModbusPal.
	 */
	public void pduProcessed();

	/**
	 * This method is triggered when a PDU has been processed and the result is an
	 * exception reply.
	 */
	public void pduException();

	/**
	 * This method is triggered when a PDU has been received but no reply is given
	 * to it.
	 */
