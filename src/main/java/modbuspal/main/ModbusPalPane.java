...
public class ModbusPalPane
	...
	/**
	 * Checks if 3rd-party RXTX library is available. It will try to load the
	...
	/**
	 * Checks if 3rd-party JFreeChart library is available. It will try to load the
	...
	/**
	 * Starts the currently selected link, as if the user has clicked on the "Run"
	 * button.
	 */
	...
	/**
	 * Stops the currently running link, as if the user has clicked on the "Run"
	 * button.
	 */
	...
	private void saveProjectButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_saveProjectButtonActionPerformed
		 ...
		 * setTitle(APP_STRING+" ("+projectFile.getName()+")"); } catch
		 * (FileNotFoundException ex) { // TODO: display an error message
		 * Logger.getLogger(ModbusPalPane.class.getName()).log(Level.SEVERE, null, ex);
		 * } catch (IOException ex) { // TODO: diplay an error message
		 * Logger.getLogger(ModbusPalPane.class.getName()).log(Level.SEVERE, null, ex);
		 * }
		 */
	...
	/**
	 * this function is triggered when the user toggles the "master" button.
	 * 
	 * @param evt
	 */
	...
	/**
	 * This method is called when the user clicks on the "enable all" button located
	 * in the "modbus slaves" frame.
	 * 
	 * @param evt
	 */
	...
	private void helpButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_helpButtonActionPerformed
		...
		helpViewer.toFront();
		/*
		 * if( Desktop.isDesktopSupported()==true ) { try { URL url =
		 * getClass().getResource("../help/index.html"); Desktop.getDesktop().browse(
		 * url.toURI() ); }
		 * 
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
		...
		dialog.append(
				"If you need to use your COM ports, go to http://www.rxtx.org and install the RXTX library that suits your system.");
		dialog.setVisible(true);
	...
	/**
	 * This method must be called when the instance of ModbusPalPane is disposed of,
	 * because it will do some cleaning: - stopping the running threads
	 * (automations, link)
	 */
	public void exit() {
		stopAll();
	...
	/**
	 * Shows or hides the the Slaves list. Some applications that embbeds ModbusPal
	 * might find it nice to hide this list.
	 * 
