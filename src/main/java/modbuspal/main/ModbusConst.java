...
/**
 * Defines the subset of the MODBUS specification that is currently supported by
 * ModbusPal.
 * 
 * @author nnovic
 */
public interface ModbusConst {
	...
	public static final byte USER_DEFINED_FUNCTION_CODES[] = { 65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 100, 101,
