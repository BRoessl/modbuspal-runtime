...
public class AutomationPanel extends javax.swing.JPanel
	...
	/**
	 * ModbusPal will call this method when the automation is removed from the
	 * project. It should not be called direcly.
	 */
	...
	/**
	 * Makes this component obtain the focus. More specifically, the focus is
	 * requested by the text field where the user edits the name of the automation.
	 */
	public void focus() {
	...
	private void initComponents() {
		...
		playToggleButton
				.setIcon(new javax.swing.ImageIcon(getClass().getResource("/modbuspal/automation/img/play.png"))); // NOI18N
		playToggleButton.setToolTipText("Start or stop this automation");
		playToggleButton.setSelectedIcon(
				new javax.swing.ImageIcon(getClass().getResource("/modbuspal/automation/img/stop.png"))); // NOI18N
		...
		showToggleButton
				.setIcon(new javax.swing.ImageIcon(getClass().getResource("/modbuspal/automation/img/show.png"))); // NOI18N
	...
	private void playToggleButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_playToggleButtonActionPerformed
		...
		if (playToggleButton.isSelected() == true) {
			/*
			 * "Play" button has been pushed, it starts the automation and the button
