...
public class AutomationListModel implements ListModel, ComboBoxModel {
	 ...
	 * Creates a new instance of AutomationListModel.
	 * 
	 * @param mpp the project from which the list of automation for this model must
	 *            be obtained
	 */
	...
	/**
	 * Creates a new instance of AutomationListModel. The list is empty.
	 */
	...
	public final void changeModel(Automation[] list) {
		...
		/*
		 * for(int i=0; i<list.length; i++) { automations.add(list[i]); }
		 */
	...
	/**
	 * Modifies the list of automations for this model by getting the list of
	 * automations defined in the specified ModbusPalProject
	 * 
	...
	/**
	 * Returns the automation that is defined at the specified index in the list.
	 * 
