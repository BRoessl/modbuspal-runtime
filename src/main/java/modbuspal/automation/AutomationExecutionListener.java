...
public interface AutomationExecutionListener {
	...
	/**
	 * this event is triggered when the current value of the automation is modified.
	 * 
	...
	/**
	 * this event is triggered when the automation has reached the end of the last
	 * generator, and restars from the beginning (implies that loop mode is
	 * enabled).
	 * 
	 * @param source the automation that triggers the event
	 */
