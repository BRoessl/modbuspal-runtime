...
/**
 * A panel that contains a chart, tracking the values of an automation
 * 
 * @author nnovic
 */
public class AutomationChart extends javax.swing.JPanel implements AutomationExecutionListener {
	...
	private void createChart() {
		...
		chart = ChartFactory.createXYLineChart(null, "Time", "Value", collection, PlotOrientation.VERTICAL, false,
				false, false);
