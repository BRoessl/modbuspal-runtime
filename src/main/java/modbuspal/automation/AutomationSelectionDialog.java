 ...
 * @author nnovic
 */
public class AutomationSelectionDialog extends javax.swing.JDialog {
	...
	/**
	 * Creates new form AutomationSelectionDialog, and specifies which automation
	 * should be selecte by default.
	 * 
	...
	/**
	 * Returns the selected automation, or null if no selection has been made, or
	 * null if the user has no validated the selection by clicking on OK.
	 * 
