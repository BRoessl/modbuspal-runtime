...
public interface AutomationEditionListener {
	/**
	 * this event is triggered when the initial value of an automation is modified.
	 * 
	 * @param source
	 * @param init
	 */
	...
	/**
	 * this event is triggered when two generators are swapped (usually, when the
	 * user clicks on the "up" or the "down" buttons).
	 * 
	 * @param source
	 * @param g1
	 * @param g2
