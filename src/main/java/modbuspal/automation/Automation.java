...
public class Automation implements Runnable {
	...
	/**
	 * This is the constructor to use when creating the automation from an xml file
	 * (i.e: loading a xmpp project). It uses the "loadAttributes" function to parse
	 * the "importable" attributes of the "automation" tag, and it also parses the
	 * non-importable attributes (like "id").
	 * 
	...
	/**
	 * This is the constructor that is used to create an new, empty automation. You
	 * have to provide a name that is unique in the scope of the current project.
	...
	/**
	 * Changes the order of the generators by putting the specified generator one
	 * rank down in the list. A "generators swapped" event is then fired. Usually,
	 * you don't call this method directly; it is triggered by clicking on the
	 * "down" button of a GeneratorRenderer.
	 * 
	 ...
	 * 
	 * @return an array containing the references of all the generators in this
	 *         automation.
	 */
	...
	/**
	 * Setup the attributes of the automation by extracting the values from an xml
	 * node.
	 * 
	 * @param attributes the xml node representing the attributes of the automation
	 */
	...
	/**
	 * Returns the duration of the steps, in seconds. A step is the delay between
	 * two updates of the automation's current value.
	 * 
	...
	/**
	 * Removes all generators from the automation that have the specified classname
	 * 
	...
	/**
	 * This method is used to add generators into the automation, by using the
	 * content of the node list. The generators are instantiated by using the
	 * provided InstantiableManager object.
	 * 
	 * @param nodes
	 * @param gf    the "generator factory", object that holds the instantiable
	 *              generators
	...
	/**
	 * Changes the name of this automation. Caution: this method won't check that it
	 * is unique, but it has to be. A "name changed" events is then fired.
	 * 
	...
	/**
	 * Creates and starts a new thread in order to execute this automation. The
	 * thread's name is set to the name of the automation. You can only have on
	 * running thread at the same time.
	 */
	public void start() {
		if (thread == null) {
	...
	/**
	 * Stops the execution of the automation. The method will be blocked until the
	...
	/**
	 * Check if the "loop" option is enabled for this automation. If so, the
	 * execution of the automation continues with the first generator of the list
	 * when the last generator is finished.
	 * 
	 ...
	 * this value will return the current value of the current generator. Otherwise,
	 * it will return the initial value.
	 * 
	 ...
	 * 
	 * @return true if the automation is running but suspended. false otherwise.
	 */
	...
	/**
	 * ModbusPal will call this function when the automation is removed from the
	 * project. It should not be called directly.
	 */
	...
	/**
	 * Changes the order of the generators by putting the specified generator one
	 * rank up in the list. A "generators swapped" event is then fired. Usually, you
	 * don't call this method directly; it is triggered by clicking on the "up"
	 * button of a GeneratorRenderer.
	 * 
	 * @param gen
	 */
