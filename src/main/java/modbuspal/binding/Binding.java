...
public abstract class Binding implements AutomationExecutionListener, Cloneable, Instantiable<Binding> {
	...
	public void reset() {
		throw new RuntimeException(
				"This method is implemented because of the Instantiable interface, but is never used");
	}

	/**
	 * This method is called by ModbusRegisters. It should not be called directly.
	 * Its purpose is to define which register is the target of the binding.
	 * 
	...
	/**
	 * This method is called by ModbusRegisters. It should not be called directly.
	 * Its purpose is to undefine which register is the target of the binding.
	 */
	...
	/**
	 * This method is called by ModbusPalProject and ModbusRegistersPanel. It should
	 * not be called directly. Its purpose is to define which automation is the
	...
	/**
	 * Process the specified value and return the 16-word register corresponding to
	 * the requested order.
	 * 
	 * @param order the rank of the 16-word register to return, depending of the
	 *              mapping implemented by this binding.
	 * @param value the value to process
	 * @return the register of the specified order, after processing of the input
	 *         value
	 */
	 ...
	 *              mapping implemented by this binding.
	 * @param value the value to process
	 * @return the boolean (coil) of the specified order, after processing of the
	 *         input value
	 */
	...
	/**
	 * Returns the name of the automation that has been associated to this binding
	 * by calling the setup() method.
	 * 
