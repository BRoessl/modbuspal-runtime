 ...
 * @author jmc15
 */
public class ModbusRequestDialog extends javax.swing.JDialog {
	...
	ModbusMasterRequest getRequest() {
		if (actionSelectorTabbedPane.getSelectedComponent() == x01_readCoilsPanel) {
			...
			return ModbusMasterRequest.getReadWriteMultipleRegistersRequest(readStartingAddress, quantityToRead,
	...
	private void implementationComboBoxActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_implementationComboBoxActionPerformed
		...
		/*
		 * switch( implementationComboBox.getSelectedIndex() ) { default: case 0: //
		 * modbus modbusSlave.setImplementation(IMPLEMENTATION_MODBUS); break; case 1:
		 * // J-Bus modbusSlave.setImplementation(IMPLEMENTATION_JBUS); break; }
		 */
