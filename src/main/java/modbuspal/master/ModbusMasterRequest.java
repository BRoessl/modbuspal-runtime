...
public class ModbusMasterRequest extends DefaultMutableTreeNode {
	...
	public static ModbusMasterRequest getReadWriteMultipleRegistersRequest(int readStartingAddress, int quantityToRead,
			int writeStartingAddress, int quantityToWrite) {
		ModbusMasterRequest output = new ModbusMasterRequest();
