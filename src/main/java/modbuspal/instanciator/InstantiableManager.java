...
public class InstantiableManager<T extends Instantiable<T>> {
	/**
	 * List of listeners that are interested in receiving events from this manager.
	 */
	 ...
	 * that is identified by "name", and call its "newInstance()" method and return
	 * the resulting object.
	 * 
	 * @param name the name of the instantiable to use in order to create a new
	 *             object
	 * @return a new object of type <T>
	 * @throws InstantiationException
	 * @throws IllegalAccessException
	 */
	public T newInstance(String name) throws InstantiationException, IllegalAccessException {
	 ...
	 * 
	 * @return array of string containing the names of the instantiables in this
	 *         manager
	 */
	...
	/**
	 * Create a standardized name for the specified object that implements the
	 * Instantiable interface
	 * 
	 * @param i the object for which a standardized name must be returned
	 * @return a standardiez name for the instance, made of the class name and the
