...
/**
 * objects interesting in notifications about a modbus slave must implement this
 * interface
 * 
 * @author nnovic
 */
public interface ModbusSlaveListener {
	...
	/**
	 * This method will be triggered to notify the listener that the name of the
	 * specified modbus slave has been modified
	 * 
	 * @param slave   the modbus slave
	 ...
	 * 
	 * @param slave        the modbus slave
	 * @param functionCode the function code to which the new pdu processor is
	 *                     assigned
	 * @param old          the old pdu processor that was assigned to the function
	 *                     code
	 * @param mspp         the new pdu processor that is now assigned to the
	 *                     function code
	 */
	public void modbusSlavePduProcessorChanged(ModbusSlave slave, byte functionCode, ModbusPduProcessor old,
			ModbusPduProcessor mspp);

	/**
	 * This method will be triggered to notify the listener that the reply delays
	 * for the specified modbus slave have been changed
	 * 
	 * @param slave the modbus slave
	...
	/**
	 * This method will be triggered to notify the listener that the error rates for
	 * the specified modbus slave have been modified
	 * 
	 * @param slave       the modbus slave
