...
/**
 * the dialog where the user selects a ModbusPduProcessor to associate with a
 * function code
 * 
 * @author nnovic
 */
public class AddFunctionsDialog extends javax.swing.JDialog {
	private final ListOfFunctions listOfFunctions;
	private final ListOfInstances listOfInstances;
	private boolean isOK = false;

	class ListOfInstances extends AbstractListModel implements ComboBoxModel {
	...
	class ListOfFunctions extends DefaultComboBoxModel {
