 ...
 * @author nnovic
 */
public class ModbusSlavePanel extends javax.swing.JPanel
	...
	private void initComponents() {
		...
		enableToggleButton
				.setIcon(new javax.swing.ImageIcon(getClass().getResource("/modbuspal/slave/img/disabled.png"))); // NOI18N
		enableToggleButton.setSelected(modbusSlave.isEnabled());
		enableToggleButton.setToolTipText("Enable or disable this slave");
		enableToggleButton
				.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/modbuspal/slave/img/enabled.png"))); // NOI18N
		...
		duplicateButton
				.setIcon(new javax.swing.ImageIcon(getClass().getResource("/modbuspal/slave/img/duplicate.png"))); // NOI18N
	 ...
	 * implicitely meaning that the content is validated by the user. report the
	 * content of the text field into the modbus slave.
	 * 
	 * @param evt
	 */
