 ...
 * @author nnovic
 */
class ModbusFunctionsPanel extends javax.swing.JPanel implements ModbusConst {
	...
	class FunctionTable extends AbstractTableModel {
		...
		public Object getValueAt(int rowIndex, int columnIndex) {
			...
			case 0:
				return Boolean.TRUE;
			case 1:
				return USER_DEFINED_FUNCTION_CODES[rowIndex];
			case 2: {
	...
	private void setFunctionsButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_setFunctionsButtonActionPerformed
		...
		if (rowCount <= 0) {
			...
			// int selectedAddresses[] =
			// ((ModbusRegistersTable)functionsTable).getSelectedAddresses();
			...
			for (int i = 0; i < selectedRows.length; i++) {
				try {
					...
					// Binding binding =
					// slaveDialog.modbusPalProject.getBindingFactory().newBinding(selectedClass);
