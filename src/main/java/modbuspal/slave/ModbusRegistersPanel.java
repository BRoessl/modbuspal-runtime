 ...
 * @author nnovic
 */
class ModbusRegistersPanel extends javax.swing.JPanel implements ModbusConst {
	...
	/*
	 * private int getTranslatedAddressAt(int selectedRow) { int address =
	 * (Integer)registersTable.getValueAt(selectedRow,
	 * ModbusRegisters.ADDRESS_COLUMN_INDEX);
	 * switch(modbusSlave.getImplementation()) { default: case
	 * IMPLEMENTATION_MODBUS: return address-1; case IMPLEMENTATION_JBUS: return
	 * address; } }
	 */
