 ...
 * @author nnovic
 */
public class ModbusSlaveDialog extends javax.swing.JDialog implements ModbusConst, ModbusSlaveListener {
	...
	public ModbusSlaveDialog(ModbusPalPane p, ModbusSlave s) {
		...
		initComponents();
		holdingRegistersPanel.add(new ModbusRegistersPanel(this, modbusSlave.getHoldingRegisters()),
				BorderLayout.CENTER);
...
//    }
	...
	private void importSlave(File importFile) throws ParserConfigurationException, SAXException, IOException,
