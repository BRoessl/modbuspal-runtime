...
public class ClassPathHacker {
	...
	/**
	 * Adds a file (usually a JAR file then) or a directory to the classpath of the
	 * java virtual machine running the application.
	 * 
	 * @param s the full path and name of the file or directory to add into the
	 *          classpath
	 * @throws IOException
	 */
