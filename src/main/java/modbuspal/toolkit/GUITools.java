...
public class GUITools {
	...
	/**
	 * Moves a component so that it is located in the middle of the boundaries of
	 * another component. In most cases, this method is used to aligndialogs and
	 * frames.
	 * 
	...
	/**
	 * Searches up all the parents of the specifed component until a Frame is found
	 * and returns null. If the root component is reached and no Frame was found,
	 * returns nulls.
	 * 
