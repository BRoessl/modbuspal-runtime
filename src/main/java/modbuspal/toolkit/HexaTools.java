...
public class HexaTools {
	...
	/**
	 * Scans the provided string, which is supposed to contain hexadecimal data,
	...
	/**
	 * Scans the provided string, which is supposed to contain hexadecimal data,
	 * into a raw byte buffer. The output buffer is provided in argument, so that
	 * the method does not create a new one.
	 * 
	 * @param data   the string containing the data
