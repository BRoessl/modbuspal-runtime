...
public class FileTools {
	...
	/**
	 * Creates an absolute path name for the "target" file. The "target" file is a
	 * relative path, and it is made absolute by resolving the "target" relative
	 * path against the "reference" absolute path.
	 * 
	 * @param reference a file with absolute path that is the root for building an
	 *                  absolute pathname for "target"
	...
	/**
	 * Creates an absolute path name for the "target" file. The "target" string is a
	 * relative path, and it is made absolute by resolving the "target" relative
	 * path against the "reference" absolute path.
	 * 
	 * @param reference a file with absolute path that is the root for building an
	 ...
	 * @return a string containing the relative path of target in comparison with
	 *         reference.
	 */
	...
	public static void copyTo(InputStream src, File dst) throws FileNotFoundException, IOException {
