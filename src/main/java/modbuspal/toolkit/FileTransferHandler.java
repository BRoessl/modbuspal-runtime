...
public class FileTransferHandler extends TransferHandler implements DropTargetListener {
	/**
	 * interface that a Component should implement to import files from a drag and
	 * drop operation involving the FileTransferHandler class.
	 */
	 ...
	 * 
	 * @param obj the object that will process the importing of the files when the
	...
	public void drop(DropTargetDropEvent dtde) {
		...
		TransferSupport support = new TransferSupport(dtde.getDropTargetContext().getComponent(),
